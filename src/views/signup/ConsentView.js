    ...
    return(
        ...
        >
            <View style={styles.container}>
                <Text style={styles.text}>Okay so how about, Do you wanna know how much youre actually making use of those subscriptions? Kindly give us usage access so you can be sure that youre not paying for an app you don't use.</Text>
                <TouchableOpacity 
